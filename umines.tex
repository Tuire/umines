...
User models can be categorized in a three dimensional space (IMAGE?), where the axes are:  single model vs. collection of models, explicitly specified models vs. models inferred by the system on the basis of user behaviour and long-term vs. short-term user models \site{rich99}.
