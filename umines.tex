...
\begin{figure}[h] % t=top, h=here, b=bottom, p=separate page, !=place even if ugly
\caption{Relevance feedback in action at http://www.dell.com. After a query, a feedback form is displayed below the search results.\protect} \label{figure_relevanceFeedback1}
...
\begin{figure}[h] % t=top, h=here, b=bottom, p=separate page, !=place even if ugly
\caption{Relevance feedback form at http://www.dell.com that has a text field for explaining the feedback further.\protect} \label{figure_relevanceFeedback2}
...
The search system at http://www.dell.com displays a form at the end of the result list.
